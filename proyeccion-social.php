    ...
    <div id="main">
    	<div class="width-container">
        	<div class="banner-boxed">
            	<img src="images/baner_proyeccion-social.png" />
            </div>
            
            <div id="sidebar-right">
            	<div class="content-boxed">
                    <ul>
                    	<li id="sidebar-right-active"><a href="#">AREA DE APOYO Y SEGUIMIENTO AL EGRESADO</a></li>
                        <li><a href="#">AREA DE PROYECCIÓN SOCIAL COMUNITARIA</a></li>
                        <li><a href="#">AREA DE EMPRENDIMIENTO Y AUTOGESTIÓN</a></li>
                    </ul>
                </div>
            </div>
            
            <div id="sidebar-left">
            	<img src="images/baner_proyeccion-social2.png" />
            </div>
